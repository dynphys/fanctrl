...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LED_RED_2_Pin LED_GREEN_2_Pin LED_RED_1_Pin */
  GPIO_InitStruct.Pin = LED_RED_2_Pin|LED_GREEN_2_Pin|LED_RED_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_GREEN_3_Pin LED_GREEN_0_Pin LED_RED_0_Pin LED_RED_3_Pin 
                           LED_GREEN_1_Pin */
  GPIO_InitStruct.Pin = LED_GREEN_3_Pin|LED_GREEN_0_Pin|LED_RED_0_Pin|LED_RED_3_Pin 
                          |LED_GREEN_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  HAL_GPIO_WritePin(GPIOB, LED_RED_2_Pin|LED_GREEN_2_Pin|LED_RED_1_Pin, GPIO_PIN_RESET);
